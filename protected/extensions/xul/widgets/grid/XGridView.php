...
Yii::import('ext.xul.widgets.XBaseListView');
Yii::import('ext.xul.widgets.grid.XDataColumn');
Yii::import('ext.xul.widgets.grid.XLinkColumn');
Yii::import('ext.xul.widgets.grid.XButtonColumn');
Yii::import('ext.xul.widgets.grid.XCheckBoxColumn');
 ...
 * @since 1.1
 */
class XGridView extends XBaseListView
{
